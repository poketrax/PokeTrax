<script lang="ts">
	...
	import { removeCardCollection, addCardCollection } from '../../lib/CollectionStore';
		...
		<div>
			...
			<div class="flex">
				<div>
					<div class="h-8" />
					{#if collection}
						<CountControl bind:count={card.count} on:change={saveCard} class="w-[330px] mb-2" />
					{/if}
					{#if card.variant?.includes('Reverse')}
						<CardImage
							width="330px"
							height="460px"
							overlay={`assets/revholo/${formatEnergy(card)}-rev.png`}
				...
				<div class="ml-2">
					...
					<div class="h-[250px] ml-2 mb-2 w-[500px] overflow-x-auto overflow-y-auto">
