<script lang="ts">
	...
	import { CardCase, Energy, CardImage, PokeRarity, CardGradeStamp } from 'tcg-case';
...
>
	...
	<CardImage
		...
		cardImg={`${baseURL}/pokemon/card_img/${encodeURI(card.expName)}/${encodeURI(card.cardId)}`}
		id={alt}
	/>
	<img
		slot="footer1"
	...
	<PokeRarity
		...
		rarity={card.rarity}
		color={card.rarity.includes('Illustration Rare') ? 'gold' : 'black'}
	/>
</CardCase>
